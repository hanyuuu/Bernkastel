...
public class Askar2Test {
	...
	public void test() {
		 ...
		 * на соответствующих уровнях: 1030, 244, 465.
		 * Ожидается, что будет произведен следующий расчет: (1030*1+244*2+465*3) и возвращено значение 2913
		 */
		/**
		 ...
		 */
		assertEquals(a.takeSum(1030, 244, 465),2913);
	}
