 ...
 */
import com.hanyuuu.reglamentcreator.CoefficientFunction;
public class Kiyom1Test {
	...
	public void test() {
		 ...
		 * на соответствующих уровнях: 1734, 1721, 1230.
		 * Ожидается, что будет произведен следующий расчет: (1734*1+1721*2+1230*3) и возвращено значение 8866
		 */
		/**
		 * Инициализация тестируемого класса
		 */
		CoefficientFunction a = new CoefficientFunction();
		/**
		 * Сравнение рассчитанного и ожидаемого значения
		 */
		assertEquals(a.takeSum(1734, 1721, 1230),8866);
	}
