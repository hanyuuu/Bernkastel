...
public class Askar1Test {
	...
	public void test() {
		 ...
		 * на соответствующих уровнях: 1780, 718, 1110.
		 * Ожидается, что будет произведен следующий расчет: (1780*1+718*2+1110*3) и возвращено значение 6546
		 */
		/**
		 ...
		 */
		assertEquals(a.takeSum(1780, 718, 1110),6546);
	}
